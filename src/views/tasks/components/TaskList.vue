<template>
  <div class="w-full">
    ...
    <!-- Loading State -->
    <div v-if="loading && !tasks.length" class="py-6 flex items-start">
      <svg class="animate-spin h-8 w-8 text-blue-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
        <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
        <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
      </svg>
      <p class="ml-4 text-gray-600">Loading your tasks...</p>
    </div>

    <!-- Empty State -->
    <div v-else-if="!tasks.length" class="bg-white rounded-lg shadow-sm border border-gray-200 text-left p-6">
      <div class="flex items-center">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-gray-400 mr-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
